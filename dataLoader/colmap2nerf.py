...
def parse_args():
	...
	parser.add_argument("--images", default="../data/images", help="输入图像路径")
...
if __name__ == "__main__":
	...
	with open(os.path.join(TEXT_FOLDER,"/home/lijingwen/Projects/code/data/sparse/sparse_txt/cameras.txt"), "r") as f:
		angle_x = math.pi / 2
		for line in f:
	...
	with open(os.path.join(TEXT_FOLDER,"/home/lijingwen/Projects/code/data/sparse/sparse_txt/images.txt"), "r") as f:
		i = 0
		...
		for line in f:
			...
			if  i % 2 == 1:
				...
				image_name = ' '.join(elems[9:])  # 获取文件名（处理含空格情况）
