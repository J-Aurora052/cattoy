...
def config_parser(cmd=None):
    ...
    parser.add_argument("--datadir", type=str, default='./data/images',
    ...
    parser.add_argument('--dataset_name', type=str, default='popmart')
    ...
    parser.add_argument("--upsamp_list", type=int, nargs='+', default=[2000, 3000, 4000, 5500, 7000],
                        help='Iteration numbers for upsampling')
    parser.add_argument("--update_AlphaMask_list", type=int, nargs='+', default=[2000, 4000],
                        help='Iteration numbers for alpha mask updates')
